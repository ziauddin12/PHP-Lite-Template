    ...
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="text-center mb-16">
            <h3 class="text-2xl md:text-3xl font-bold mb-4">
                <?php echo htmlspecialchars($data['newsletterTitle']); ?>
            </h3>
            <p class="text-slate-400 mb-8 max-w-2xl mx-auto">
                <?php echo htmlspecialchars($data['newsletterDisclaimer']); ?>
            </p>
            ...
            <form class="flex flex-col sm:flex-row gap-4 max-w-md mx-auto" action="#" method="POST">
                <div class="flex-1">
                    <input type="email" 
                           name="email" 
                           placeholder="<?php echo htmlspecialchars($data['newsletterPlaceholder']); ?>"
                           required
                ...
                <button type="submit" 
                        class="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors duration-200 whitespace-nowrap">
                    Anmelden
                </button>
            </form>
        </div>
        ...
        <div class="grid <?php echo $data['gridColumns']; ?> gap-8 mb-12">
            ...
            <!-- Services Column (for extended/comprehensive) -->
            <?php if (isset($data['serviceNavigation']) && !empty($data['serviceNavigation'])): ?>
                <div>
                    <h4 class="text-white font-semibold mb-4">Dienstleistungen</h4>
                    <ul class="space-y-3">
            ...
            <!-- Legal Links Column (for extended/comprehensive) -->
        ...
        <div class="border-t border-slate-800 pt-8">
            <div class="flex flex-col md:flex-row items-center justify-between">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="#" class="text-slate-400 hover:text-white transition-colors duration-200" title="Instagram">
                        <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (newsletterForm) {
        newsletterForm.addEventListener('submit', function(e) {
            ...
            // Hier würde normalerweise die Newsletter-Anmeldung verarbeitet
            alert('Newsletter-Anmeldung für ' + email + ' erfolgreich! (Demo-Modus)');
